...
#define PUSH(NAME, REG1, REG2) static void PUSH_##NAME(Intel8080 *cpu) { \
...
// Pop Stack into REG
#define POP(NAME, REG1, REG2) static void POP_##NAME(Intel8080 *cpu) { \
...
// Exchange HL and DE
static void XCHG(Intel8080 *cpu) {
    uint16_t i = *cpu->HL;
    *cpu->HL = *cpu->DE;
    *cpu->DE = i;
}
...
static void XTHL(Intel8080 *cpu) {
    uint8_t h = *cpu->H;
    uint8_t l = *cpu->L;
