...
// Compare A with REG
#define CMP(REG) static void CMP_##REG(Intel8080 *cpu) { \
...
// Compare A with (HL)
static void CMP_M(Intel8080 *cpu) { \
...
// Add (REG) to A
#define ADD(REG) static void ADD_##REG(Intel8080 *cpu) { \
...
static void ADD_M(Intel8080 *cpu) { \
...
// Add (REG + carry) to A
#define ADC(REG) static void ADC_##REG(Intel8080 *cpu) { \
...
static void ADC_M(Intel8080 *cpu) {
...
// Subtract (REG) from A
#define SUB(REG) static void SUB_##REG(Intel8080 *cpu) { \
    int16_t i = *cpu->A - *cpu->REG; \
    *cpu->A = i & 0xff; \
    cpu_flag_szp(cpu, cpu->A); \
    *cpu->F |= i < 0; \
...
static void SUB_M(Intel8080 *cpu) { \
    int16_t i = *cpu->A - cpu->read_mem(*cpu->HL);
    *cpu->A = i & 0xff; // mask to 255
...
#define SBB(REG) static void SBB_##REG(Intel8080 *cpu) { \
...
static void SBB_M(Intel8080 *cpu) {
...
// Add BC to HL
static void DAD_B(Intel8080 *cpu) {
...
// Add DE to HL
static void DAD_D(Intel8080 *cpu) {
...
// Add HL to HL
static void DAD_H(Intel8080 *cpu) {
...
// Add SP to HL
static void DAD_SP(Intel8080 *cpu) {
